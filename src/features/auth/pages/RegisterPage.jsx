...
export const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden rounded-r-3xl bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700">
        <div className="absolute inset-0">
          {/* Background Pattern */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-10 left-10 w-40 h-40 border-2 border-white rounded-lg transform rotate-12"></div>
            <div className="absolute top-32 right-20 w-32 h-32 border-2 border-white rounded-lg transform -rotate-6"></div>
            <div className="absolute bottom-40 left-20 w-36 h-36 border-2 border-white rounded-lg transform rotate-45"></div>
            <div className="absolute bottom-20 right-32 w-28 h-28 border-2 border-white rounded-lg transform -rotate-12"></div>
          </div>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-white">
            ...
            <p className="text-lg text-white/80 text-center max-w-md">
              Manage your properties, track compliance, monitor assets, and stay on top of everything — all in one place.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-background p-4 lg:p-8 min-h-[calc(100vh-12rem)] lg:min-h-screen">
        <div className="w-full max-w-md py-8 lg:py-0">
          ...
          <p className="text-muted-foreground mb-8 text-sm lg:text-base">
            Join thousands of landlords who save 10+ hours weekly managing their properties. No credit card required.
          </p>

          {/* General Error Message */}
          {errors.general && (
            <p className="mb-6 text-sm text-red-500">{errors.general}</p>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label
                htmlFor="email"
                className={errors.email ? "text-red-500" : "text-foreground"}
              >
                Email Address
              </Label>
              <Input
            ...
            <div className="space-y-2">
              <Label
                htmlFor="password"
                className={errors.password ? "text-red-500" : "text-foreground"}
              >
                Password
              </Label>
            ...
            <div className="space-y-2">
              <Label
                ...
                className={errors.confirmPassword ? "text-red-500" : "text-foreground"}
              >
                Confirm Password
              </Label>
              <div className="relative">
